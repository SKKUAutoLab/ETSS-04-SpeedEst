...
from config_pose_for_speed.core.evaluation.top_down_eval import (keypoint_auc, keypoint_epe,
                                                  keypoint_nme,
                                                  keypoint_pck_accuracy)
from config_pose_for_speed.datasets import DatasetInfo
from config_pose_for_speed.datasets.pipelines import Compose
...
class Kpt2dSviewRgbImgTopDownDataset(Dataset, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        print('=====> Son print flip_pairs: ', self.ann_info['flip_pairs'])
