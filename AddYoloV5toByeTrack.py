...
def main(opt):
    ...
    for frame_idx, (path, im, im0s, vid_cap, s) in enumerate(dataset):
        # Son Define new info image for Byetrack
        # img_size = (720, 1280)
        # info_img = [720, 1280]
        t1 = time_sync()
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                print("This is im0 size: {}: {}".format(im0.shape[0], im0.shape[1]))
                det[:, :4] = scale_coords(im.shape[2:], det[:, :4], im0.shape).round()
                print('This is inferenced yolo5: ', det)
                ...
                online_targets = tracker.update(output, info_img, img_size)
                online_tlwhs = []
                online_ids = []
                online_scores = []
            ...
            if save_vid:
                if vid_path[i] != save_path:  # new video
                    ...
                    if vid_cap:  # video
                        ...
                        fps, w, h = 30, online_im.shape[1], online_im.shape[0]
