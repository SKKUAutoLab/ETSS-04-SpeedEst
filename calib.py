...
if __name__ == "__main__":
    ...
    # Son calibrate video
    vid = '../../Datasets/brnocompspeed/data/2016-ITS-BrnoCompSpeed/dataset/session1_right/video.avi'
    calib = '../video/calibration.txt'
    calib_video(vid, debug=True, out_path=calib)