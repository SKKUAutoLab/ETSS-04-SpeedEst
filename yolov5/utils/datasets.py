...
class LoadImages:
    ...
    def new_video(self, path):
        ...
        # Son define cut at frame N = 11000:
        print("====> Set Cap for given position ok: ")
        # self.cap.set(cv2.CAP_PROP_FPS, 50)
        self.cap.set(cv2.CAP_PROP_POS_FRAMES, 11700)
        self.frames = int(self.cap.get(cv2.CAP_PROP_FRAME_COUNT))
        # DEBUG
        frame_rate = self.cap.get(cv2.CAP_PROP_FPS)
        print('This is frame rate: ', frame_rate)
    #SON DEBUG
