...
from config_pose_for_speed.core.camera import CAMERAS
from config_pose_for_speed.core.post_processing import (affine_transform, fliplr_regression,
                                         get_affine_transform)
from config_pose_for_speed.datasets.builder import PIPELINES
